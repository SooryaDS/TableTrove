...
<body>
    <div class="welcome-container">
        ...
        <div class="welcome-buttons">
            <button class="customer-button" onclick="location.href='/customer-register'">Are you a Customer?</button>
            <button class="restaurant-button" onclick="location.href='/restaurant-login'">Are you a Restaurant?</button>
        </div>
    </div>
</body>
</html>
